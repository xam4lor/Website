...
export default function Header(props: { children?: React.ReactNode, style?: React.CSSProperties, showScrollButton?: boolean }) {
    return (
        <header className={`${styles.header} ${montserrat.className}`} style={props.style}>
            <div className={styles.container}>
                <div className={styles.content + ' ' + montserrat}>
                    <div className={styles.logo}>
                        <Image src='/imgs/logo.png' alt="ExplorableScience logo" height={350} width={350} priority />
                    </div>
                    ...
                    <div className={styles.text}>
                        ...
                        <div className={styles.title}>
                            <p className={styles.titleUp}>Explorable</p>
